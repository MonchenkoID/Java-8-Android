...
public class CarDefaultDrivableChildOfChild implements DrivableChildOfChild {

    private static final String TAG = CarDefaultDrivableChildOfChild.class.getSimpleName();
